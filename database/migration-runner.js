...
`;
  ...
  async runMigrations(direction = 'up') {
    ...
    if (direction === 'up') {
      ...
      migrationsToRun = files.filter(file => executed.includes(file.name)).reverse();
    }
...
//         console.log("Usage:");
//         console.log(
//           "  node migration-runner.js up        Run pending migrations",
//         );
//         console.log(
...
//         );
//         console.log("  node migration-runner.js seed      Run seeders");
//         break;
//     }
//   } catch (error) {
