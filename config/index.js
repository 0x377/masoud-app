...
const config = {
  ...
  rateLimit: {
    ...
    skipSuccessfulLogins: process.env.RATE_LIMIT_SKIP_SUCCESSFUL_LOGINS === 'true',
  },
  ...
  auth: {
    ...
    refreshTokenExpiry: parseInt(process.env.AUTH_REFRESH_TOKEN_EXPIRY || '604800'),
    maxDevices: parseInt(process.env.AUTH_MAX_DEVICES || '5'),
    passwordResetExpiry: parseInt(process.env.AUTH_PASSWORD_RESET_EXPIRY || '3600'),
    emailVerificationExpiry: parseInt(process.env.AUTH_EMAIL_VERIFICATION_EXPIRY || '86400'),
    phoneVerificationExpiry: parseInt(process.env.AUTH_PHONE_VERIFICATION_EXPIRY || '300'),
  ...
  family: {
    ...
    supportEmail: process.env.FAMILY_ASSOCIATION_SUPPORT_EMAIL || 'support@masoud.com',
    supportPhone: process.env.FAMILY_ASSOCIATION_SUPPORT_PHONE || '+966500000000',
  },
